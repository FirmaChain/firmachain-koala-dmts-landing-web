...
export const ButtonItems = [
  {
    color: ['#E26B3C', '#FF5C00'],
    icon: [BannerKoalaIcon],
    url: KOALA_HUB_URI,
    alt: 'KOALA KNIGHT',
    arrowIcon: [BannerArrowKoalaIcon, BannerArrowKoalaIconHover],
  },
  {
    color: ['#FFFFFF', '#494949'],
  ...
  {
    color: ['#4D77C8', '#0047CF'],
    icon: [BannerVerifyIcon],
    url: FIRMACHAIN_VERIFY_URI,
    alt: 'FIRMACHAIN VERIFY',
    arrowIcon: [BannerArrowVerifyIcon, BannerArrowVerifyIconHover],
  },
];
