  ...
  return (
    <CarouselBox>
      ...
      <ArrowButton
        ...
        onClick={() => (currentSlide === 0 ? null : handlePrevSlide())}
      >
        <IconPixelArrowLeft />
      </ArrowButton>
      <ArrowButton
        $position={'RIGHT'}
        $isEndPoint={currentSlide === CarouselItems.length - 1}
        onClick={() => (currentSlide === CarouselItems.length - 1 ? null : handleNextSlide())}
      >
        <IconPixelArrowRight />
      </ArrowButton>
    </CarouselBox>
