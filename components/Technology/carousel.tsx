...
import { CarouselContainer, ContentBox, DescBox, DescDot, DescriptionTypo, DescWrap, SlideBox, SlideImageWrap, StyledSliderForTech, TabBox, TabTypo, TabTypoWrap, TabWrap } from "./styles";
            ...
            <TabBox>
                ...
                <TabTypoWrap>
                    {CarouselItems.map((value, index) => {
                        ...
                        const invisibleDivider = (selectTab === 0 && index === 0) || selectTab === 1 || (selectTab === 2 && index === 1);
                        return (
