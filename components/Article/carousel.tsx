...
import { IconArticleArrow, IconExternalItem, ImageArticleSliderNext, ImageArticleSliderPrev, ImageTabDivider } from "../Images";
                        ...
                        {ExternalItems.map((value, index) => {
                            ...
                            return (
                                <Fragment key={value.alt}>
                                    ...
                                    {visibleDivider && <ImageTabDivider height={"32px"} invisible={false} />}
                                </Fragment>
                            );
                        })}
                    </ExternalWrap>
