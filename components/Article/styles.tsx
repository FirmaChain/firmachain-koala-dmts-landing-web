...
export const BackgroundDim = styled.div`
    ...
    top: 0;
    left: 0;
    background: linear-gradient(180deg, rgba(255, 255, 255, 0.7) 8.91%, rgba(255, 255, 255, 0) 39.06%), url(<path-to-image>), lightgray -123.412px -47.505px / 113.081% 114.516% no-repeat;
    opacity: 0.2;
`;
