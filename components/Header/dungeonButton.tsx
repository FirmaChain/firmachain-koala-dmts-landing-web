...
const DungeonButton = ({ isMenu = false }: IProps) => {
    ...
    return (
        <DungeonButtonWrap $isMenu={isMenu} onMouseOver={() => setHover(true)} onMouseLeave={() => setHover(false)} onClick={() => LinkExternal(KOALA_HUB_URI)}>
            <HoverBackround />
            <ButtonTypo $isMenu={isMenu}>{"GO DUNGEON"}</ButtonTypo>
            <IconDungeonLight />
            <ArrowIconBox>
                <ArrowIconWrap $visible={hover === false}>
                    <ImageWrap>
                        <ImageComponent src={DungeonArrowIcon} alt={"GO DUNGEON"} />
                    </ImageWrap>
                </ArrowIconWrap>
                <ArrowIconWrap $visible={hover === true}>
                    <ImageWrap>
                        <ImageComponent src={DungeonArrowIconHover} alt={"GO DUNGEON"} />
                    </ImageWrap>
                </ArrowIconWrap>
            </ArrowIconBox>
        </DungeonButtonWrap>
